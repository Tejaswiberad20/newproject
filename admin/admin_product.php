...
<table class="table">
    ...
    <tr>
      <td>1</td>     
       <td>Lakme Sun Expert Tinted Sunscreen</td>
      <td>299</td>
      <td>3</td>
      <td>MRP inclusive of all taxes on all products</td>
      <td>Face</td>
      <td><a href="updateproduct.php"class="link"><button class="btn">Update</button></a><button class="btn btn2">Delete</button></td>
