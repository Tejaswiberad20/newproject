...
<div class="background fs-4 shadow">
    ...
    <div class="row row-cols-1 row-cols-md-4 g-4 mx-4  ">
      <div class="col my-3 ">
        ...
        <img src="../imges/lip1.webp"class="productimg">
        <h3 class="Category">10% OFF</h3>

          <div class="card-body">
          <h3 class="productName fs-5">liquid lipsticks Shades Set 6</h3>
        <h4><del>Rs.299</del>&nbsp;Rs.199/-</h4>
      ...
      <div class="col my-3 ">
        <div class="card  product-box">
        <img src="../imges/lip2.webp"class="productimg">       
         <h3 class="Category">10% OFF</h3>
        <div class="card-body">
        <h3 class="productName fs-5"> Elle 18 Color Pops matte lipstick</h3>
        <h4><del>Rs.299</del>&nbsp;Rs.199/-</h4>
        <button class="btn">Buy Now</button>
          </div>
        </div>
      ...
      <div class="col my-3">
      <div class="card  product-box">
      <img src="../imges/face3.webp"class="productimg">
      <h3 class="Category">10% OFF</h3>
        <div class="card-body">
        <h3 class="productName fs-5">Mars High Coverage Liquid Foundation</h3>
        <h4><del>Rs.299</del>&nbsp;Rs.199/-</h4>
        <button class="btn">Buy Now</button>
          </div>
        </div>
      ...
      <div class="col my-3">
      <div class="card  product-box">
      <img src="../imges/face4.webp"class="productimg">
      <h3 class="Category">10% OFF</h3>
        <div class="card-body">
        <h3 class="productName fs-5">MAKE UP FOR
        HD Skin All-In-One Face Palette</h3>
        <h4><del>Rs.299</del>&nbsp;Rs.199/-</h4>
        <button class="btn">Buy Now</button>
          </div>
        </div>
  ...
  <div class="product">
    <div class="row row-cols-1 row-cols-md-4 g-4 mx-4  ">
      <div class="col my-3 ">
        <div class="card  product-box">
        <img src="../imges/face5.webp"class="productimg">
        <h3 class="Category">10% OFF</h3>
          <div class="card-body">
          <h3 class="productName fs-5">High colour payoff Vegan & cruelty-free</h3>
        <h4><del>Rs.299</del>&nbsp;Rs.199/-</h4>
        <button class="btn">Buy Now</button>
          </div>
        </div>
      ...
      <div class="col my-3 ">
        <div class="card  product-box">
        <img src="../imges/face6.webp"class="productimg">
        <h3 class="Category">10% OFF</h3>
        <div class="card-body">
        <h3 class="productName fs-5">Bollywood Filter<br> Primer </h3>
        <h4><del>Rs.299</del>&nbsp;Rs.199/-</h4>
        <button class="btn">Buy Now</button>
      ...
      <div class="col my-3">
      <div class="card  product-box">
      <img src="../imges/face7.webp"class="productimg">
      <h3 class="Category">10% OFF</h3>
        <div class="card-body">
        <h3 class="productName fs-5">Lakme Illuminating Loose Powder </h3>
        <h4><del>Rs.299</del>&nbsp;Rs.199/-</h4>
        <button class="btn">Buy Now</button>
          </div>
        </div>
      ...
      <div class="col my-3">
      <div class="card  product-box">
      <img src="../imges/face8.webp"class="productimg">
      <h3 class="Category">10% OFF</h3>
        <div class="card-body">
        <h3 class="productName fs-5">New Natural Glow Face Powder from Pond's</h3>
        <h4><del>Rs.299</del>&nbsp;Rs.199/-</h4>
        <button class="btn">Buy Now</button>
          </div>
        </div>
