...
<body>
    <div class="background fs-4 shadow">
        <nav class="navbar navbar-expand-lg nav">
            <div class="container-fluid">
                <a class="navbar-brand" href="#"><img src="../imges/logo.avif" class="logo-img"></a>
    ...
    <div class="order-box">
        <div class="pinfo">
            <img src="../imges/face1.webp" class="pimg">
            <div>
                <h4 class="pname"><b>Lakme Sun Expert Tinted Sunscreen</b></h4>
                <ul type="circle" class="info">
                    <li>MRP inclusive of all taxes on all products</li>
                    <li>Net Quantity: 100 g</li>
                </ul>
                <p class="price"><b>Rs.299/-</b></p>
                <div class="qty">
                    <img src="../imges/plus.png" class="qimg" onclick="inc()"style="height:30px;"><span style="font-size:25px;" id="quantity-text">1</span>
                    <img src="../imges/minus.png" class="qimg" onclick="dec()"style="height:30px;">&nbsp;
                </div>
                <p class="quantity-total" id="show-quantity">Quantity : 1</p>

                <h2 class="price" style="margin-top:30px;" id="show-total"><b>Total: Rs.299/-</b></h2>
            </div>
        </div>
        ...
        <div class="footer-body">
            <div class="footer-container">
                <div class="footer-container2">
                    ...
                    <a href="mailto:tejaswiberad2004@gmail.com" class="h5 footer-contact-us">Email: customer.service@choicefootwear.com</a>
                </div>
                <div>
                    ...
                    <div style="display: block; align-items: center;">
                        ...
                        <div><a href="#" class="h5 footer-quick-links">Signup</a></div>
                    </div>
                </div>
                <div>
    ...
    <script>
        function inc() {
            ...
            showTotal.innerText = `Total: Rs.${quantity * 299}/-`;
        }
